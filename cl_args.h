...
{PRINT_OXDNA           , 0, "o", "oxDNA"         , option::Arg::None,     "  --oxDNA, -o\n          Print a topology/configuration oxDNA pair of files for the given sequence and the minimum energy configuration" },
