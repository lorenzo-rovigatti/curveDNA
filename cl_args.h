...
{PRINT_LOCAL_BENDING   , 0, "b", "bending"       , option::Arg::Optional, "  --bending, -b\n          Print the local bending of the sequence. The output filename is the input filename plus the .bnd extension." },
{PRINT_CURVATURE       , 0, "c", "curvature"     , option::Arg::Optional, "  --curvature, -c\n          Print the curvature of the sequence. The output filename is the input filename plus the .crv extension." },
{0,0,0,0,0,0}
};
