...
{PRINT_LOCAL_BENDING   , 0, "b", "bending"    , option::Arg::None,     "  --bending, -b\n          Print the local bending of the sequence. If the name of the input file is sequence.txt, the output file will be named sequence.txt.bnd" },
{0,0,0,0,0,0}
};
